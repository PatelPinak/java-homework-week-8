...
public class C04_Main {
    public static void main(String[] args) {
        C02_Carpet carpet = new C02_Carpet(3.5);
        C01_Floor floor = new C01_Floor(2.75, 4.0);
        C03_Calculator calculator = new C03_Calculator(floor, carpet);
        System.out.println("total= " + calculator.getTotalCost());
        carpet = new C02_Carpet(1.5);
        floor = new C01_Floor(5.4, 4.5);
        calculator = new C03_Calculator(floor, carpet);
        System.out.println("total= " + calculator.getTotalCost());
    }
